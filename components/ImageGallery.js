...
export default function ImageGallery() {
  ...
  return (
    <section className="bg-gradient-to-b from-[#1a1a1a] to-[#222222] py-20 md:py-28 overflow-hidden relative">
      {/* Background glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[300px] bg-[#2F6FED] opacity-5 rounded-full blur-[100px] pointer-events-none" />
        ...
        <div className="relative">
          ...
          >
            {imageGallery.images.map((img, idx) => (
              <div
                key={idx}
                className="flex-shrink-0 snap-center w-56 md:w-64 rounded-2xl overflow-hidden border border-white/10 hover:border-[#2F6FED]/50 transition-all duration-300 hover:scale-[1.02] shadow-lg"
              >
