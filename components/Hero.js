...
export default function Hero() {
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-[#111111] via-[#1a1a1a] to-[#222222] overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#2F6FED] opacity-10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-[#2F6FED] opacity-5 rounded-full blur-[100px] pointer-events-none" />

      {/* Navbar */}
      <nav className="relative z-10 flex items-center justify-between px-6 md:px-12 py-5 border-b border-white/5">
        <span className="text-2xl font-black text-white tracking-tight">
          <span className="text-[#2F6FED]">{hero.brandHighlight}</span>{hero.brandSuffix}
        </span>
        <button
          onClick={scrollToOffer}
          className="hidden md:block bg-[#2F6FED] hover:bg-[#1E4FBE] text-white font-bold text-sm px-5 py-2.5 rounded-full transition-all duration-200 hover:scale-105"
        >
          {hero.cta}
        </button>
      </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col gap-6 animate-fade-in-up">
            ...
            <div className="inline-flex items-center gap-2 self-start">
              <span className="flex items-center gap-1.5 bg-[#2F6FED]/15 border border-[#2F6FED]/40 text-[#2F6FED] font-bold text-xs px-4 py-1.5 rounded-full uppercase tracking-widest">
                <Zap size={12} fill="#2F6FED" />
                {hero.badge}
              </span>
            </div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white leading-[1.1]">
              {hero.headline}{" "}
              <span className="text-[#2F6FED]">{hero.headlineHighlight}</span>
            </h1>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-1.5 text-white/60 text-sm font-medium">
                <CheckCircle2 size={14} className="text-[#2F6FED]" />
                {hero.socialProof}
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              <button
                onClick={scrollToOffer}
                className="animate-pulse-glow bg-[#2F6FED] hover:bg-[#1E4FBE] text-white font-black text-lg px-8 py-4 rounded-2xl transition-all duration-200 hover:scale-105 shadow-lg shadow-[#2F6FED]/30 uppercase tracking-wide"
              >
                {hero.cta}
              </button>
            </div>
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              ...
              <div className="absolute inset-0 bg-[#2F6FED]/20 rounded-3xl blur-2xl scale-110" />
              <div className="relative w-full max-w-sm lg:max-w-md">
                <Image
                  src="/mockup/estonia.webp"
                ...
                <div className="absolute -top-4 -right-4 bg-[#2F6FED] text-white font-black text-sm px-4 py-2 rounded-2xl shadow-xl rotate-6">
