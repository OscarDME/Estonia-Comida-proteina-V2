...
export default function Closing() {
  ...
  return (
    <section className="bg-gradient-to-b from-[#111111] to-[#0a0a0a] py-20 md:py-28 relative overflow-hidden">
      {/* Background glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-[#2F6FED] opacity-5 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 md:px-12 text-center">
            ...
            return (
              ...
              >
                <div className="w-12 h-12 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center">
                  <Icon size={20} className="text-[#2F6FED]" />
                </div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-3xl p-8 max-w-md mx-auto mb-8">
          ...
          <div className="text-5xl font-black text-[#2F6FED] leading-none mb-2">
            {closing.priceNew}
          </div>
        ...
        <a
          ...
          className="animate-pulse-glow block w-full max-w-md mx-auto bg-[#2F6FED] hover:bg-[#1E4FBE] text-white font-black text-lg py-5 rounded-2xl text-center transition-all duration-200 hover:scale-[1.02] shadow-2xl shadow-[#2F6FED]/30 tracking-wide mb-10"
        >
          {closing.cta}
        </a>
        ...
        <div className="flex justify-center mb-8">
          <Image
            src="/Logos-garantia-sin-fondo/Estonia-garantia.webp"
