...
const BASE_CHECKOUT_URL = "https://www.oriopay.app/p/tervislikud-retseptid-v2";
...
export default function FinalCta() {
  ...
  return (
    <section
      id="lk"
      className="bg-gradient-to-br from-[#E8EEFE] to-[#DCE7FD] py-20 md:py-28 relative overflow-hidden"
    >
      {/* Background decoration */}
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#2F6FED] opacity-10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[300px] h-[300px] bg-[#2F6FED] opacity-8 rounded-full blur-[80px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 md:px-12">
        ...
        <h2 className="text-2xl md:text-4xl font-black text-center text-[#2F6FED] mb-4">
        ...
        <div className="grid grid-cols-1 max-w-md mx-auto gap-6">
          {finalCta.packages.map((pkg, idx) => (
            <div
              key={idx}
              className="bg-white rounded-3xl shadow-2xl border-2 border-[#2F6FED] overflow-hidden"
            >
              {/* Card header */}
              <div className="bg-[#2F6FED] px-6 py-5 text-center">
              ...
              <div className="px-6 py-6">
                ...
                <div className="text-center mb-6">
                  ...
                  <div className="text-4xl font-black text-[#2F6FED] leading-none mb-1">
                    {pkg.priceNew}
                  </div>
                  {pkg.pricePerMonth && (
                ...
                <ul className="flex flex-col gap-2.5 mb-6">
                  {pkg.items.map((item, i) => (
                    <li key={i} className="flex items-start gap-2.5">
                      <CircleCheckBig
                        size={16}
                        className="text-[#2F6FED] flex-shrink-0 mt-0.5"
                      />
                ...
                <a
                  ...
                  className="animate-pulse-glow block w-full bg-[#2F6FED] hover:bg-[#1E4FBE] text-white font-black text-base py-4 rounded-2xl text-center transition-all duration-200 hover:scale-[1.02] shadow-xl shadow-[#2F6FED]/30 tracking-wide"
                >
                  {pkg.cta}
                </a>
              </div>
