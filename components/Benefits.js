...
export default function Benefits() {
  return (
    <section className="bg-[#F4F7FE] py-20 md:py-28">
      <div className="max-w-6xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-16">
          {benefits.stats.map((stat, idx) => (
            ...
            >
              <div className="text-5xl md:text-6xl font-black text-[#2F6FED] leading-none mb-2">
                {stat.value}
              </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {benefits.categories.map((cat, idx) => (
                <div
                  key={idx}
                  className="bg-white rounded-2xl p-5 text-center shadow-md border border-white hover:border-[#2F6FED]/30 hover:shadow-lg transition-all duration-200"
                >
            ...
            {/* Mini CTA */}
            <div className="mt-8 p-6 bg-gradient-to-r from-[#2F6FED] to-[#1E4FBE] rounded-2xl text-white">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 bg-white text-[#1E4FBE] font-black text-sm px-5 py-2.5 rounded-xl hover:bg-gray-50 transition-colors"
              >
